...
-- 학생 - 수강신청 - 과목
    ...
    CREATE TABLE ENROLL_T(
        ...
        SUBJECT_NO  NUMBER  REFERENCES SUBJECT_T(SUBJECT_NO) ON DELETE SET NULL -- 과목이 지워지면 수강신청에서 과목번호만 지운다. 학번은 지우지 않는다.
    );
...
CREATE TABLE ENROLMENT(
    ...
    SUBJECT_NO  NUMBER  REFERENCES SUBJECT(SUBJECT_NO) NOT NULL
);
-- 테이블 삭제
