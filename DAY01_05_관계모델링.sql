--실습(PPT 6장 데이터베이스 오브젝트 설계서 기반 작성)
...
CREATE TABLE EMPLOYEE_T(
    ...
    DEPT_NO     VARCHAR2(15 BYTE)   REFERENCES DEPARTMENT_T(DEPT_NO) ON DELETE SET NULL, -- ON DELETE 부분 부서가 없어졌다고 사원이 없어지면 안됨. 여기 부분은 생각하고 해야할 듯,,참조할 키 타입 맞춰줘야 함. 이름은 달라도 됨.
...
CREATE TABLE PROCEEDING_T(
    ...
    PJT_NO      NUMBER REFERENCES PROJECT_T(PJT_NO) ON DELETE SET NULL, -- 프로젝트에 참여했었던 사원들의 정보는 남겨둔다.
